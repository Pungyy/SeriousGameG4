...
<head>
    ...
    <title>Prolent</title>
    <link rel="icon" type="image/x-icon" href="assets/img/logo_sm.png">
    ...
    <nav class="bg-gray px-6 py-2 dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex md:order-2">
                <a href="#escape">
                    <button type="button" class="play-btn text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Jouer</button>
                </a>
